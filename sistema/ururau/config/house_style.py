...
# URURAU v47.2 — matriz editorial única
try:
    from ururau.editorial.regras_editoriais import obter_briefing_editorial as _b, obter_termos_ia_proibidos as _t, detectar_termos_ia as _d
    BRIEFING_EDITORIAL=_b(); TERMOS_IA_PROIBIDOS=_t()
    def detectar_termos_ia(texto: str) -> list[str]: return _d(texto)
