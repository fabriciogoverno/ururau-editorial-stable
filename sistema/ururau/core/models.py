...
class Materia:
    ...
    # ── v46.7: Telemetria explícita de IA/fallback ─────────────────────────
    modo_geracao:              str   = ""   # openai_gpt4mini | fallback_sem_ia
    ia_provider:               str   = ""   # openai | local
    ia_modelo:                 str   = ""
    ia_status:                 str   = ""   # openai_ok | openai_invalid_api_key | fallback_local...
    ia_etapa:                  str   = ""
    ia_chamada_ok:             bool  = False
    ia_fallback_motivo:        str   = ""
    ia_erros:                  list  = field(default_factory=list)
    ia_texto_final_origem:     str   = ""   # openai | fallback_local
    ia_openai_status:          str   = ""   # status raiz da chamada OpenAI quando existir
    ia_openai_chamada_ok:      bool  = False
    ia_erro_original_openai:   dict  = field(default_factory=dict)
