# -*- coding: utf-8 -*-
"""V47.22 FIX - Reparo do botão PARAR do monitor no painel, sem erro unicodeescape."""
...
def bk(p):
    if p.exists():
        b = p.with_suffix(p.suffix + '.bak_v47_22_fix')
        if not b.exists():
            shutil.copy2(p, b)
...
bat('21_VALIDAR_MONITOR_PARAR_V47_22.bat', r'''@echo off
cd /d "%~dp0sistema"
...
print('[V47.22 FIX] aplicado. Rode .\\21_VALIDAR_MONITOR_PARAR_V47_22.bat e depois .\\02_ABRIR_PAINEL.bat')
